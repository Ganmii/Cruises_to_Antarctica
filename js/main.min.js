...
var menuContainer = document.querySelector('.burger');
var menu = menuContainer.querySelector('.burger__list');
var links = document.querySelectorAll('.nav__link');
var toggle = menuContainer.querySelector('.burger__toggle');
var closingMenu = menuContainer.querySelector('.burger__close');
var promo = document.querySelector('.promo');
var map = document.querySelector('#map-canvas');
var mapImage = map.querySelector('.contacts__image');
var ymaps = window.ymaps;
var MAP_CENTER = [59.938667, 30.323073];
var ZOOM = 19;
var PIN_SIZE = [18, 22];
var PIN_OFSET = [-18, -22];
...
if (menuContainer) {
  ...
  links.forEach(function (el) {
    return el.addEventListener('click', removeMenu);
  });
}
